...
# pbar is == dataloader
def regress_pred(model, int_classifier, pbar, num_samples, m_p3d_handover, right_hand_loss):
    """
...
def test(config, model, dataloader, int_classifier) :
    ...
    pbar = dataloader
    m_p3d_handover, right_hand_loss, under_10, under_15, under_20, under_30, under_35, under_40, accuracy, f1, f1_binary  = regress_pred(model, int_classifier, pbar, num_samples, m_p3d_handover,right_hand_loss)
...
if __name__ == "__main__":
    ...
    print(test(config, model, dataloader, int_classifier))
